...
public static class BedrockResourceDefinitions
{
    ...
    public static JavaResourceDefinition BehaviorPack { get; } =
        new(JavaResourceKind.BedrockBehaviorPack, "行为包", string.Empty, null, true, false, false,
            CurseForgeBedrockGameId);

    public static JavaResourceDefinition ResourcePack { get; } =
        new(JavaResourceKind.BedrockResourcePack, "资源包", string.Empty, null, true, false, false,
            CurseForgeBedrockGameId);
    ...
    public static JavaResourceDefinition WorldTemplate { get; } =
        new(JavaResourceKind.BedrockWorldTemplate, "世界模板", string.Empty, null, true, false, false,
            CurseForgeBedrockGameId);
}