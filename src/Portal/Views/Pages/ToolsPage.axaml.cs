...
public partial class ToolsPageViewModel : ObservableObject, IDisposable
{
    ...
    public ToolsPageViewModel() => NavigateType(typeof(BedrockToolsPage));
    ...
    private void NavigateType(object? parameter)
    {
        ...
        if (!_pageCache.TryGetValue(pageType, out var page) && Activator.CreateInstance(pageType) is UserControl newPage)
