...
/// <summary>
/// 将 Mojang 新闻正文（HTML）解析为 Avalonia 控件序列。
/// <para><c>&lt;p&gt;</c> → TextBlock；<c>&lt;h1&gt;-&lt;h6&gt;</c> → 不同字号的 TextBlock；
/// <c>&lt;a&gt;</c> → HyperlinkButton（块级独立 / 段内通过 InlineUIContainer 嵌入）；
/// <c>&lt;strong&gt;</c>、<c>&lt;b&gt;</c> → Bold；<c>&lt;em&gt;</c>、<c>&lt;i&gt;</c> → Italic；
/// <c>&lt;code&gt;</c> → 等宽字体 Run；<c>&lt;ul&gt;</c> / <c>&lt;ol&gt;</c> → StackPanel 列表。</para>
/// <para>正文默认字重 DemiBold，强调/标题字重 Bold。</para>
/// </summary>
public static class NewsHtmlRenderer
{
    ...
    /// <summary>把 parent 的子节点添加到目标 InlineCollection 中。</summary>
