...
using AuthServer = Portal.Views.Components.Operations.Account.AuthServer;
using AuthServerDetectedViewModel = Portal.Views.Components.Operations.Account.AuthServerDetectedViewModel;
using AuthServerViewModel = Portal.Views.Components.Operations.Account.AuthServerViewModel;
using NewMinecraftFolderViewModel = Portal.Views.Components.Operations.OpenFile.NewMinecraftFolderViewModel;
using YggdrasilAccountViewModel = Portal.Views.Components.Operations.Account.YggdrasilAccountViewModel;
