...
internal static class OrdinalSymbolMapping
{
    ...
    private static readonly Dictionary<uint, string> Oleaut32 = new()
    {
        { 2, "SysAllocString" },
        { 3, "SysReAllocString" },
        { 4, "SysAllocStringLen" },
    ...
    private static readonly Dictionary<uint, string> Ws2_32 = new()
    {
        { 1, "accept" },
        { 2, "bind" },
        { 3, "closesocket" },
    ...
    public static string Lookup(Module module, uint ordinal)
    {
        return module switch
        {
            Module.Oleaut32 => Oleaut32.ContainsKey(ordinal) ? Oleaut32[ordinal] : $"ord{ordinal}",
            Module.Wsock32 => Ws2_32.ContainsKey(ordinal) ? Ws2_32[ordinal] : $"ord{ordinal}",
            Module.Ws2_32 => Ws2_32.ContainsKey(ordinal) ? Ws2_32[ordinal] : $"ord{ordinal}",
