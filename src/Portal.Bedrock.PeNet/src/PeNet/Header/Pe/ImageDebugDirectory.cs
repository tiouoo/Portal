...
///     and
///     https://docs.microsoft.com/en-us/dotnet/api/system.reflection.portableexecutable.debugdirectoryentrytype?view=net-5.0
/// </summary>
public enum DebugDirectoryType : uint
{
    ...
    /// <summary>
    ///     The entry points to a blob containing Embedded Portable PDB. The Embedded Portable PDB blob has the following
    ///     format:
