...
public class ImageBaseRelocation : AbstractStructure
{
    ...
    /// <summary>
    ///     RVA of the relocation block.>	PeNet.dll!PeNet.Structures.ImageBaseRelocation.ImageBaseRelocation(PeNet.IRawFile
    ///     peFile, long offset, uint relocSize) Line 26	C#
    /// </summary>
