...
public class StringTable : AbstractStructure
{
    ...
    ///     Should only be present if the VS_FF_PRIVATEBUILD flag is set in the dwFileFlags member of the VsFixedFileInfo
    ///     structure.
    /// </summary>
    ...
    ///     This entry should only be present if the VS_FF_SPECIALBUILD flag is set in the dwFileFlags member of the
    ///     VsFixedFileInfo structure.
    /// </summary>
