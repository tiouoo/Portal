...
internal class Sha256 : Hash
{
    ...
    protected override void DoFinal(Span<byte> output, int outOff)
    {
        ...
        Pack.UInt32_To_BE(_h6, output, outOff + 20);
        Pack.UInt32_To_BE(_h7, output, outOff + 24);
        Pack.UInt32_To_BE(_h8, output, outOff + 28);
    ...
    {
        for (var ti = 16; ti <= 63; ti++) _x[ti] = Theta1(_x[ti - 2]) + _x[ti - 7] + Theta0(_x[ti - 15]) + _x[ti - 16];
