...
internal class DotNetStructureParsers
{
    ...
    private MetaDataStreamStringParser? InitMetaDataStreamStringParser()
    {
        ...
        return metaDataStream == null
            ? null
            : new MetaDataStreamStringParser(_peFile, MetaDataHdr!.Offset + metaDataStream.RelOffset,
                metaDataStream.Size);
    }
    ...
    private MetaDataStreamGuidParser? InitMetaDataStreamGUIDParser()
    {
        ...
        return metaDataStream == null
            ? null
            : new MetaDataStreamGuidParser(_peFile, MetaDataHdr!.Offset + metaDataStream.RelOffset,
                metaDataStream.Size);
    }
    ...
    private MetaDataStreamBlobParser? InitMetaDataStreamBlobParser()
    {
        ...
        return metaDataStream == null
            ? null
            : new MetaDataStreamBlobParser(_peFile, MetaDataHdr!.Offset + metaDataStream.RelOffset,
                metaDataStream.Size);
    }
}