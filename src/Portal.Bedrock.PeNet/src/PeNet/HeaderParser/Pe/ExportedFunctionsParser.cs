...
internal class ExportedFunctionsParser : SafeParser<ExportFunction[]>
{
    ...
    protected override ExportFunction[]? ParseTarget()
    {
        ...
        var ordOffset = _exportDirectory.NumberOfNames == 0
            ? 0
            : _exportDirectory.AddressOfNameOrdinals.RvaToOffset(_sectionHeaders);
        var nameOffsetPointer = _exportDirectory.NumberOfNames == 0
            ? 0
