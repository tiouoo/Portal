...
internal class ResourcesParser : SafeParser<Resources>
{
    ...
    public ResourcesParser(IRawFile peFile, uint offset, ResourceLocation? vsVersionLocation,
        ResourceLocation[] iconDirectoryLocations, ResourceLocation[] groupIconDirectoryLocations) : base(peFile,
        offset)
    {
