...
pkgname=portal-mc-cnb-bin
pkgver=0.0.0.0
pkgrel=1
pkgdesc="Portal - Minecraft launcher/manager (stable release, CNB mirror)"
arch=('x86_64')
url="https://portal.tiouo.cc/"
license=('GPL-3.0-or-later')
depends=('fuse2' 'hicolor-icon-theme' 'xdg-utils')
provides=("portal-mc=$pkgver")
conflicts=('portal-mc' 'portal-mc-bin' 'portal-mc-commit-bin' 'portal-mc-nightly-bin')
options=('!strip' '!emptydirs')
_appimg="Portal.AppImage"
source_x86_64=(
    "$_appimg::https://cnb.cool/tiouo/portal/-/releases/download/v$pkgver/Portal.linux.x64.AppImage"
