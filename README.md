...
| ----------------------- |------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
| **Windows 10 / 11 x64** | [安装程序](https://github.com/tiouou/Portal/releases/latest/download/Portal.win.x64.installer.zip) / [便携版](https://github.com/tiouou/Portal/releases/latest/download/Portal.win.x64.portable.zip) | [安装程序](https://github.com/tiouou/Portal/releases/download/publish-commit/Portal.win.x64.installer.zip) / [便携版](https://github.com/tiouou/Portal/releases/download/publish-commit/Portal.win.x64.portable.zip) | [安装程序](https://github.com/tiouou/Portal/releases/download/publish-nightly/Portal.win.x64.installer.zip) / [便携版](https://github.com/tiouou/Portal/releases/download/publish-nightly/Portal.win.x64.portable.zip) |
| **macOS Apple Silicon** | [磁盘映像](https://github.com/tiouou/Portal/releases/latest/download/Portal.osx.mac.arm64.dmg) / [应用包](https://github.com/tiouou/Portal/releases/latest/download/Portal.osx.mac.arm64.app.zip) | [磁盘映像](https://github.com/tiouou/Portal/releases/download/publish-commit/Portal.osx.mac.arm64.dmg) / [应用包](https://github.com/tiouou/Portal/releases/download/publish-commit/Portal.osx.mac.arm64.app.zip) | [磁盘映像](https://github.com/tiouou/Portal/releases/download/publish-nightly/Portal.osx.mac.arm64.dmg) / [应用包](https://github.com/tiouou/Portal/releases/download/publish-nightly/Portal.osx.mac.arm64.app.zip) |
| **macOS Intel**         | [磁盘映像](https://github.com/tiouou/Portal/releases/latest/download/Portal.osx.mac.x64.dmg) / [应用包](https://github.com/tiouou/Portal/releases/latest/download/Portal.osx.mac.x64.app.zip) | [磁盘映像](https://github.com/tiouou/Portal/releases/download/publish-commit/Portal.osx.mac.x64.dmg) / [应用包](https://github.com/tiouou/Portal/releases/download/publish-commit/Portal.osx.mac.x64.app.zip) | [磁盘映像](https://github.com/tiouou/Portal/releases/download/publish-nightly/Portal.osx.mac.x64.dmg) / [应用包](https://github.com/tiouou/Portal/releases/download/publish-nightly/Portal.osx.mac.x64.app.zip) |
| **Linux x64**           | [AppImage](https://github.com/tiouou/Portal/releases/latest/download/Portal.linux.x64.AppImage) / [deb包](https://github.com/tiouou/Portal/releases/latest/download/Portal.linux.x64.deb) / [rpm包](https://github.com/tiouou/Portal/releases/latest/download/Portal.linux.x64.rpm) | [AppImage](https://github.com/tiouou/Portal/releases/download/publish-commit/Portal.linux.x64.AppImage) / [deb包](https://github.com/tiouou/Portal/releases/download/publish-commit/Portal.linux.x64.deb) / [rpm包](https://github.com/tiouou/Portal/releases/download/publish-commit/Portal.linux.x64.rpm) | [AppImage](https://github.com/tiouou/Portal/releases/download/publish-nightly/Portal.linux.x64.AppImage) / [deb包](https://github.com/tiouou/Portal/releases/download/publish-nightly/Portal.linux.x64.deb) / [rpm包](https://github.com/tiouou/Portal/releases/download/publish-nightly/Portal.linux.x64.rpm) |
