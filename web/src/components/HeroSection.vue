    ...
    <div class="hero-copy">
      ...
      <div class="hero-actions">
        <a class="button primary" :href="downloadUrl">
          <svg v-if="detectedOS === 'windows'" class="button-icon" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M3 5.2 10.5 4v7.2H3V5.2Zm8.5-1.4L21 2.5v8.7h-9.5V3.8ZM3 12.3h7.5v7.2L3 18.4v-6.1Zm8.5 0H21V21l-9.5-1.3v-7.4Z" />
          </svg>
          <svg v-else-if="detectedOS === 'macos'" class="button-icon" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M16.7 12.7c0-2.4 2-3.6 2.1-3.7a4.6 4.6 0 0 0-3.6-2c-1.5-.2-3 1-3.8 1s-2-1-3.3-1C6.4 7 4.8 8 3.9 9.5c-1.9 3.3-.5 8.1 1.3 10.7.9 1.3 2 2.7 3.4 2.6 1.3-.1 1.8-.9 3.5-.9 1.6 0 2.1.9 3.5.9s2.4-1.3 3.3-2.6c1-1.5 1.5-3 1.5-3.1-.1 0-3.7-1.4-3.7-4.4ZM14.2 5.4A4.4 4.4 0 0 0 15.3 2a4.7 4.7 0 0 0-3.1 1.6A4.1 4.1 0 0 0 11 6.8c1.2.1 2.4-.5 3.2-1.4Z" />
          </svg>
          <svg v-else class="button-icon" viewBox="0 -1 17 17" aria-hidden="true">
