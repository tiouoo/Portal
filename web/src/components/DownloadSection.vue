...
import { platforms, channelBase, cnbBase } from '../data/downloads';
import AurInstallPanel from './AurInstallPanel.vue';

const route = ref('direct');
const channel = ref<'release' | 'nightly' | 'commit'>('release');
