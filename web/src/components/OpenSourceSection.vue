...
const openQQ = () => {
  window.open('https://qm.qq.com/q/MZJRX3Rc4K', '_blank');
};
</script>
...
.oss-mark {
  ...
  box-shadow: 0 12px 30px rgba(55, 65, 90, 0.08);
}
.oss-mark img {
  width: 42px;
  height: 42px;
...
.button:hover {
  background: #2d374c;
  box-shadow: 0 8px 22px rgba(29, 38, 57, 0.18);
}
.button.dark {
  height: 46px;
  background: #20283a;
