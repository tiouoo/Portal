...
type Channel = keyof typeof bases;

export const channelBase = (channel: Channel) => bases[channel] || bases.nightly;
export const cnbBase = (channel: Channel) => cnbBases[channel] || cnbBases.nightly;
